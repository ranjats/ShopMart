...
const Dashboard = ({ onLogout, shopName }) => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={() =>
                setView(view === "orders" ? "inventory" : "orders")
              }
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div
              className={`p-3 rounded-full ${waStatus.status === "connected" ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-600"}`}
            >
              <Smartphone size={24} />
            </div>
            <div>
